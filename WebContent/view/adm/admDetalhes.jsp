	...
	<div class="ts-main-content">
		<nav class="ts-sidebar">
			...
			<ul class="ts-sidebar-menu">
				...
				<li><a href="solicitacaoAdm"><i class="fa fa-copy"></i>Solicitar
						Cópias</a></li>
				<li class="open"><a href="admListarSolicitacao"><i
						class="fa fa-table"></i>Consultar Solicitações</a></li>
				<li><a href="admListarUsuario"><i class="fa fa-user"></i>Lista
						de Usuários</a></li>
				<li><a href="admCadastrar"><i class="fa fa-edit"></i>Cadastrar
						Usuário</a></li>
			</ul>
		</nav>
					...
					<div class="col-md-12">
						<h2 class="page-title">
							<font color="#999999">&nbsp;Administração /</font> <font
								color="#666666">Detalhes da Solicitação</font>
						</h2>
