...
<title>AdministraÁ„o - IFPE CÛpias</title>
<!-- Font awesome -->
	...
	<div class="ts-main-content">
		<nav class="ts-sidebar">
			...
			<ul class="ts-sidebar-menu">
				...
				<li><a href="AdmSolicitar"><i class="fa fa-copy"></i>Solicitar CÛpias</a></li>
				
				<li><a href="#"><i class="fa fa-table"></i>Consultar SolicitaÁıes</a></li>
				
				<li class="open"><a href="admListarUsuario"><i class="fa fa-user"></i>Lista de Usu·rio</a></li>
				
				<li><a href="#"><i class="fa fa-edit"></i>Cadastrar Usu·rio</a>
				</li>
			</ul>
		</nav>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">
							<font color="#999999">&nbsp;AdministraÁ„o /</font> <font
								color="#666666">Lista de Usu·rios</font>
						</h2>
